...
bot = Client("bot",
             bot_token= "7013245438:AAGzhyP4LeU-fodq-szE1whnvXCsuLiGw9M",
             api_id=10499690,
             api_hash= "87d0414dc159c10225cac921edde640a")
auth_users = [5457168404,6055613126,-1002047950889]
...
async def txt_handler(bot: Client, m: Message):
    ...
    try:
        for i in range(arg, len(links)):
            ...
            try:                               
                cc = f'** {str(count).zfill(3)}.** {name1} ({res}) om.mkv\n**Batch Name :** {b_name}\n\n**Downloaded by : {CR}**'
                cc1 = f'** {str(count).zfill(3)}.** {name1} om.pdf \n**Batch Name :**{b_name}\n\n**Downloaded by : {CR}**'
                if "drive" in url:
                    try:
